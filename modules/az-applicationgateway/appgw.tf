...
resource "azurerm_application_gateway" "appgw" {
  ...
  gateway_ip_configuration {
    ...
    subnet_id = var.subnet_id /* Subnet ID where the Application Gateway will be deploy */
  }
  ...
  */
  ...
  /* Purpose: Holds the list of backend servers (VMs, VMSS, or IP addresses) that the Application Gateway will route traffic too
  ...
  dynamic "backend_http_settings" {
    ...
    content {
      ...
      probe_name            = backend_http_settings.value.probe_name != null ? backend_http_settings.value.probe_name : null /* Name of the health probe to associate with this backend HTTP setting. Must match a defined health probe in the Application Gateway. */
    }
  }
